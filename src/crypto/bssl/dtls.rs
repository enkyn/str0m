...
impl BsslDtlsImpl {
    pub fn new(cert: BsslDtlsCert) -> Result<Self, super::CryptoError> {
...
impl DtlsInner for BsslDtlsImpl {
...
pub fn dtls_create_ctx(cert: &BsslDtlsCert) -> Result<SslContext, CryptoError> {
